...
const VOCABULARY_WRITTEN_FORMS: Record<string, string> = {
  あめ: '雨', いぬ: '犬', うま: '馬', えき: '駅', おに: '鬼',
  かさ: '傘', きつね: '狐', くるま: '車', けーき: 'ケーキ', こども: '子ども',
  さくら: '桜', しお: '塩', すいか: '西瓜', せみ: '蝉', そら: '空',
  たこ: '蛸', ちかてつ: '地下鉄', つき: '月', てら: '寺', とけい: '時計',
  なみ: '波', にく: '肉', ぬの: '布', ねこ: '猫', のり: '海苔',
  はな: '花', ひる: '昼', ふね: '船', へや: '部屋', ほし: '星',
  まち: '町', みみ: '耳', むし: '虫', めがね: '眼鏡', もも: '桃',
  やま: '山', ゆき: '雪', よる: '夜', らーめん: 'ラーメン', りす: '栗鼠',
  るびー: 'ルビー', れいぞうこ: '冷蔵庫', ろく: '六', わに: '鰐', を: 'を', ん: 'ん',
  がっこう: '学校', ぎんこう: '銀行', ぐみ: 'グミ', げーむ: 'ゲーム', ごはん: '御飯',
  ...
  にゅうがく: '入学', にょろにょろ: 'にょろにょろ', ひゃく: '百', ひゅーまん: 'ヒューマン', ひょう: '豹',
